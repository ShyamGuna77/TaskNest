        ...
        <div className="relative overflow-hidden rounded-[18px] bg-gradient-to-br from-[#4D89FE] via-[#6B9BFF] to-[#ADC9FF] px-6 py-12 md:px-16 lg:px-28 lg:py-16">
          ...
          <div className="relative z-10 flex flex-col items-center gap-8 text-center">
            ...
            <div className="flex flex-col items-center gap-5 max-w-[790px]">
              {/* Main Heading */}
              <h1 className="text-white text-3xl md:text-4xl lg:text-5xl font-bold leading-tight tracking-tight">
                Ready to Step Into a Brighter HR Future?
              </h1>
              
              {/* Supporting Text */}
              <p className="text-white text-lg md:text-xl leading-relaxed max-w-2xl">
                Schedule a free demo today and discover how Lumify can bring light to your HR processes with AI-powered tools.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              ...
              <div className="relative">
                ...
                <button className="relative px-6 py-3 rounded-[10px] bg-gradient-to-b from-[#060612] to-[#292930] border-[3px] border-[#3F3F45] shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105">
              ...
              <div className="relative">
                ...
                <button className="relative px-6 py-3 rounded-[10px] bg-gradient-to-b from-[#F4F4F4] to-[#FEFEFE] border-[3px] border-white shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105">
                  <span className="text-[#06071A] font-bold text-sm">Download App</span>
                </button>
              </div>
            </div>
          </div>
